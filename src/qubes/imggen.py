...
#
# Copyright (C) 2013-2014  Wojciech Porczyk <wojciech@porczyk.eu>
#
...
def make_padlock(dst, colour, size=qubes.imgconverter.ICON_MAXSIZE, disp=False):
    cs = cairo.ImageSurface(cairo.FORMAT_ARGB32, size, size)

    cr = cairo.Context(cs)
    cr.set_source_rgb(*qubes.imgconverter.hex_to_float(colour))
